//Kyrin canonneer job advancement
var status = -1;
...
function start(mode, type, selection) {
	...
	if (status == 0){                  
	    qm.sendNext("Before I teach you the ways of the Cannoneer, you will have to accomplish a very difficult test.");
        }else if (status == 1) {
            ...
            qm.forceStartQuest();
            qm.sendNext("Oh.. Oh no.. The quest map looks a bit buggy.. I think I'll just have to trust your skills. Talk to me again.")
...
function end(mode, type, selection) {    
	...
	if (status == 0 && qm.haveItem(4031013, 30)){
            ...
            qm.sendNext("You have proven yourself to be worthy, I shall mold your body into a #bCannoneer#k.");       
        }else if (status == 2){
            qm.gainItem(4031013, -30);
	        qm.changeJob(530);
	        qm.sendOk("You are now a #bCannoneer#k");
