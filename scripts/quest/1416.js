...
function start(mode, type, selection) {
	...
	qm.sendNext("I am impressed, you surpassed the test. Only few are talented enough. You have proven yourself to be worthy, I shall mold your body into a #bMage (Ice, Lightning)#k.");
	qm.gainItem(darkMarble, -30)
	qm.completeQuest(1416);
	qm.changeJob(job);
	qm.sendNext("You are now a #bMage (Ice, Lightning)#k.")
	qm.dispose();	
	} else {
