...
function start(mode, type, selection) {
	...
	if (status == 0){                  
	    qm.sendNext("Before I teach you the ways of the Brawler, you will have to accomplish a very difficult test.");
        }else if (status == 1) {
...
function end(mode, type, selection) {    
	...
	if (status == 0 && qm.haveItem(4031013, 30)){
            ...
            qm.sendNext("You have proven yourself to be worthy, I shall mold your body into a #bBrawler#k.");       
        }else if (status == 2){
            qm.gainItem(4031013, -30);
	    qm.changeJob(510);
	    qm.sendOk("You are now a #bBrawler#k");
