var letters = [
    "What is Lirin's favourite animal?",
    "What is the main colour of the Yeti Pyramid Area?",
    "Please bring me the letters [REINDEER]",
    "Which Valentine Rose is level 48?",
    "How much EXP does it take for level 1-2?",
    "Who exchanges Vote Points in FM?",
    "Who is the owner of this server (HINT: A _ _ _ _ _ _) ?",
    ...
    "What is the item needed for 3rd job advancement?",
    /*"What NPC gives you a Pokemon starter?",*/
    "What are the animals that the Wild Hunter rides?",
    "Complete this job class: Knights of ?",
    "The ranks of the potentials are: Rare, Epic, ?",
    "What is the name of the top statue of Pink Bean?",
    "What town is closest to Horntail?",
    "What level can you go to Zakum?"
];
var answers = [
    "WOLF", "YELLOW", "REINDEER", "BLUE", "FIFTEEN", "PHOENIX", "AWESOME", "EIGHT", "HENESYS", "EDELSTEIN", "RESISTANCE", "ONYX", "AFRIEN", "POLEARM", "CHECKY", "DARKCRYSTAL", /*"GAGA",*/ "JAGUAR", "CYGNUS", "UNIQUE", "ARIEL", "LEAFRE", "FIFTY"
];
function init() {
