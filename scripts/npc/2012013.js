 ...
 */
var status = 0;
var STATION_TO_LUDI = 200000121;
var TICKET_TO_LUDI = 4031074;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (train == null) {
            ...
            cm.dispose();
        } else if (!cm.haveItem(TICKET_TO_LUDI)) {
            cm.sendNext("You don't have #i" + TICKET_TO_LUDI + "# #bTicket to Ludibrium (Regular)#k. You can buy one in #bOrbis Station Entrance#k. Bye.");
            cm.dispose();
