...
public class CommandProcessor {
    ...
    private final static Map<String, CommandObject> commands = new HashMap<String, CommandObject>();
    private final static Map<Integer, ArrayList<String>> commandList = new HashMap<Integer, ArrayList<String>>();
