...
public abstract class MapleEvent {
    ...
    public static void givePrize(final MapleCharacter chr) {
        ...
        switch (reward) {
            ...
            case 4 -> chr.dropMessage(5, "There was no reward.");
            default -> {
                int max_quantity = 1;
                switch (reward) {
                    case 5062000 -> max_quantity = 3;
                    case 5220000 -> max_quantity = 25;
                    case 4031307, 5050000 -> max_quantity = 5;
                    case 2022121 -> max_quantity = 10;
                }
    ...
    public static final void mapLoad(final MapleCharacter chr, final int channel) {
        for (var t : MapleEventType.values()) {
