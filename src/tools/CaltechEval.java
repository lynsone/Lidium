...
public class CaltechEval {
    ...
    private double eval(String s) {
        ...
        return doubleValue.parseDouble((String) tokens.elementAt(0));
        ...
        while (tokens.size() > 1) {
            ...
            if (OperatorsLeftRight[iop]) {
                if (!st.equals(",")) {
                    ...
                    if (it > 0) {
                        ...
                        if (getOperator(stleft) != -1) {
                            ...
                            leftValue = doubleValue.parseDouble(stleft);
                        }
                    } else {
                        ipt = 0;
                        leftValue = 0.0;
                    ...
                    rightValue1 = doubleValue.parseDouble(stright);
                ...
                if (nargs > 1) {
                    ...
                    rightValue2 = doubleValue.parseDouble(stright);
                }
